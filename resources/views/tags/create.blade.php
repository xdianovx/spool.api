                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="firstName" name="name"
                                        placeholder="Введите название тега" value="{{ old('name') }}" required>
                                    @error('name')
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="form-check mt-3">
                                        <input name="display" class="form-check-input" type="radio" value="false"
                                            id="defaultRadio1" @if (old('display') == "false") checked="checked" @else @endif>
                                    ...
                                    <div class="form-check">
                                        <input name="display" class="form-check-input" type="radio" value="true"
                                            id="defaultRadio2" @if (old('display') == "true") checked="checked" @else @endif>
